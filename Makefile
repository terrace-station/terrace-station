OBJEKTE  = openglwidget.o openglwindow.o mausobjekt.o textur.o targetinfomenu.o system.o texturensammlung.o station.o district.o deck.o room.o wall.o door.o rect.o
CPP      = g++
CPPFLAGS = -g
...
targetinfomenu.o: targetinfomenu.cpp targetinfomenu.hh mausobjekt.o
	$(CPP) -c targetinfomenu.cpp $(CPPFLAGS)
